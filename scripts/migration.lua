script.on_configuration_changed(function()
	...
	for i,reactor in pairs(global.reactors) do --updating signals for removed fuel cell mods
	...
	for i, ruin in pairs(global.ruins) do --if ruin setting was changed
		if ruin.entity.valid == true then
			ruin.entity.minable = not (settings.startup["meltdown-mode"].value == "meltdown with ruin") or (ruin.entity.health >999)
		end
	end
